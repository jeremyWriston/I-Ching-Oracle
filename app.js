...
//CREATE HEX1 ELEMENTS
    ...
    document.querySelector("#hex1-above").innerText = `above ${above1Chinese}: ${above1Symbolic} ${above1Alchemical}`;
    ...
    document.querySelector("#hex1-below").innerText = `below ${below1Chinese}: ${below1Symbolic} ${below1Alchemical}`;
    
    document.querySelector("#hex1-judgement").innerText = "THE JUDGMENT";
    document.querySelector("#hex1-judgement-text").innerText = hex1Data.wilhelm_judgment.text;

    document.querySelector("#hex1-image").innerText = "THE IMAGE";
    document.querySelector("#hex1-image-text").innerText = hex1Data.wilhelm_image.text;
...
//CREATE HEX1 ELEMENTS
    ...
    document.querySelector("#hex2-above").innerText = `above ${above2Chinese}: ${above2Symbolic} ${above2Alchemical}`;
    ...
    document.querySelector("#hex2-below").innerText = `below ${below2Chinese}: ${below2Symbolic} ${below2Alchemical}`;
    
    document.querySelector("#hex2-judgement").innerText = "THE JUDGMENT";
    document.querySelector("#hex2-judgement-text").innerText = hex2Data.wilhelm_judgment.text;

    document.querySelector("#hex2-image").innerText = "THE IMAGE";
    document.querySelector("#hex2-image-text").innerText = hex2Data.wilhelm_image.text;

//CREATE CHANGING LINES
    let lineToString = ["at the beginning",
        "in the second place",
        "in the third place",
        "in the fourth place",
        "in the fifth place",
        "at the top"];
    //let lineNum = [1, 2, 3, 4, 5, 6];   
    ...
    for (let i = 0; i < hex1.length; i++) {
        if (hex1[i] === 6) {
            ...
            changingP.innerText = hex1Data.wilhelm_lines[`${i}`].text;
